...
async function getAllRoomsREM() {
    const response = await fetch('http://localhost:3000/habitaciones/obtenerHabitaciones');
...
function editRoom(id,numero,info,equipamiento,valor,ubicacion,estado,categoria,nombreCategoria) {
    ...
    window.location.href = `/admin-createEditRoom?id=${id}&numero=${numero}&info=${info}&equipamiento=${equipamiento}&valor=${valor}&ubicacion=${ubicacion}&estado=${estado}&categoria=${categoria}&nombreCategoria=${nombreCategoria}`;
}
